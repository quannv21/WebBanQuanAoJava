...
public class OrderService {
    ...
    @Transactional
    public Order createOrder(String customerName,String customerPhone, String customerAddress, String customerEmail,
                             String customerNote, String customerPayment, List<CartItem> cartItems) {
